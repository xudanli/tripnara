...
const envSchema = z.object({
  ...
  LLM_PROVIDER: z.enum(['openai', 'deepseek', 'gemini']).optional(),
  LLM_MODEL_OPENAI: z.string().min(1).optional(),
  LLM_MODEL_DEEPSEEK: z.string().min(1).optional(),
  LLM_MODEL_GEMINI: z.string().min(1).optional(),
